...
#anvil ore creation
execute as @e[type=minecraft:falling_block,nbt={BlockState: {Name: "minecraft:anvil"}}] positioned as @s if block ~ ~-2 ~ minecraft:stone run function flatunobtainables:anvil_stone
execute as @e[type=minecraft:falling_block,nbt={BlockState: {Name: "minecraft:anvil"}}] positioned as @s if block ~ ~-2 ~ minecraft:deepslate run function flatunobtainables:anvil_deepslate